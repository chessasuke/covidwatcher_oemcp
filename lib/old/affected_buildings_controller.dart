...
//
//import 'package:covid_watcher/controllers/event_repository.dart';
//import 'package:covid_watcher/map/dropdown_rate_filter.dart';
...
//  final eventRepository = ref.watch(eventsProvider).state;
//
//  print(
...
//      if (namesBuild[i].toLowerCase().contains(filterName.toLowerCase())) {
...
//  else {
////    for (int i = 0; i < eventNotifier.events.length; i++) {
////      String tempName = eventNotifier.events[i].buildingName;
//    for (int i = 0; i < eventRepository.length; i++) {
//      String tempName = eventRepository[i].buildingName;
//      int index = buildingNotifier.state.affectedBuildings
//          .indexWhere((element) => element.name == tempName);
//      if (index != null && index != -1) {
//        buildingNotifier.state.affectedBuildings[index]
////            .addBuildingTimeLineEvent(eventNotifier.events[i]);
//            .addBuildingTimeLineEvent(eventRepository[i]);
//      } else {
//        final int index = namesBuild.indexWhere((String element) =>
////            element == eventNotifier.events[i].buildingName);
//            element == eventRepository[i].buildingName);
//        if (index != null && index != -1) {
////          print('adding: ${namesBuild[index]}');
//          buildingNotifier.state.addBuilding(
//            AffectedBuilding(
//              centroid:
//                  Offset(centerBuild[index].first, centerBuild[index].last),
...
//            )..addBuildingTimeLineEvent(eventRepository[i]),
//          );
////          buildingNotifier.state.addName(
////            namesBuild[index],
////          );
//        }
//      }
...
//  BuildingController() {
//    print('BuildingController constructor');
//  }
//
////  List<String> _affectedBuildingNames = [];
////  UnmodifiableListView<String> get affectedBuildingNames =>
////      UnmodifiableListView(_affectedBuildingNames);
//
